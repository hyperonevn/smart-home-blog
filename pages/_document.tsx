    ...
    return (
      <Html lang={config.lang} className={cn(initialColorScheme)}>
        <Head>
          ...
          {/* To ensure the initial background color follows media preference when ThemeProvider is not ready */}
          <style>
            {`
            .color-scheme-unset, .color-scheme-unset body {
              background-color: ${config.lightBackground} !important;
            }
            @media (prefers-color-scheme: dark) {
              .color-scheme-unset, .color-scheme-unset body {
                  background-color: ${config.darkBackground} !important;
               }
             }
           `}
          </style>
